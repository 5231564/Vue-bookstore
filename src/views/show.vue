  ...
  <div>
        ...
        <div class="Menu" >
          <el-menu class="el-menu-demo" mode="horizontal" >
            <el-menu-item index="1" @click="listdata">类型</el-menu-item>
            
            <el-menu-item index="2" @click="changeByType(type='小说')">小说</el-menu-item>
            <el-menu-item index="3" @click="changeByType(type='历史')">历史</el-menu-item>
            <el-menu-item index="4" @click="changeByType(type='艺术')">艺术</el-menu-item>
            <el-menu-item index="5" @click="changeByType(type='趣味读物')">趣味读物</el-menu-item>
          </el-menu>
        </div>
        <div>
          <el-row style="text-align: center;margin-left: 20%;margin-right: 20%"
